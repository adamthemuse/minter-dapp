const contractAddress = "0x26E67bd2b4af4eDE55129E4F54B30C72d1Ff433A"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the Blue Bay One NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'BlueBay One is a NFT project that aims to fractionized bluechip NFT. More information on <a href="https://bluebaynft.io"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
